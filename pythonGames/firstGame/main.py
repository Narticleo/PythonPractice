...
pg.display.set_caption("Battle Ships!")
#load imgs
img_background = pg.image.load(os.path.join("imgs","background.jpg")).convert()
img_ship = pg.image.load(os.path.join("imgs","ships.jpg")).convert()
img_meteorite = pg.image.load(os.path.join("imgs","meteorite.jpg")).convert()
img_bullet = pg.image.load(os.path.join("imgs","bllet.png")).convert()
